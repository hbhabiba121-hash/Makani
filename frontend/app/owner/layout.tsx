...
import { LayoutDashboard, Home, DollarSign, FileText, LogOut, Bell, Search, ChevronDown, Settings, User } from "lucide-react";
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ow-divider {
          ...
          margin: 0.5rem 0.75rem; flex-shrink: 0;
        }
        ...
        .ow-lang {
          ...
          overflow: hidden; margin-${isRTL ? "left" : "right"}: 4px;
        }
        .ow-lang-btn {
          ...
          <nav className="ow-nav">
            {navItems.map(({ href, labelKey, icon: Icon }) => (
              <Link
                key={href}
                href={href}
                className={`ow-item${active(href) ? " ow-active" : ""}`}
              >
          ...
          <header className="ow-nb">
            ...
            <div className="ow-nb-right">
              ...
              <div className="ow-lang">
                <button
                  className={`ow-lang-btn${lang === "fr" ? " on" : ""}`}
                  onClick={() => setLang("fr")}
                >FR</button>
                <button
                  className={`ow-lang-btn${lang === "ar" ? " on" : ""}`}
                  onClick={() => setLang("ar")}
                >ع</button>
              </div>
