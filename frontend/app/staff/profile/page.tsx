            ...
            <div className="pf-card-head">
              ...
              {!editing
                ...
                : <div style={{ display:"flex", gap:8 }}>
                    <button className="pf-btn pf-btn-outline" onClick={() => { setEditing(false); setImageFile(null); setImagePreview(null); setFormData({ first_name: user?.first_name || '', last_name: user?.last_name || '', email: user?.email || '' }); }} disabled={saving}>
                      <X size={13}/> Annuler
                    </button>
